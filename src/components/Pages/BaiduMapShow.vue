		...
		<div class="middle-tool-content">
			...
			<div class="distance-content">
				<el-tooltip effect="dark" content="测距" placement="right" :hide-after="2000">
					<img class="img-class1" src="../../assets/mapShowImg/distance32.png" height="60%" width="60%"
					     @click="openDistanceTool"/>
				</el-tooltip>
			</div>
			<div class="feedback-content">
				<el-tooltip effect="dark" content="意见反馈" placement="right" :hide-after="2000">
					<img class="img-class1" src="../../assets/mapShowImg/feedback32.png" height="60%" width="60%"
			...
			<div class="online-content">
				<el-tooltip effect="dark" content="在线客服" placement="right" :hide-after="2000">
					<el-popover
						...
						<img class="img-class1" src="../../assets/mapShowImg/online32.png" height="60%" width="60%"
						     slot="reference"/>
					</el-popover>
				</el-tooltip>
			</div>
