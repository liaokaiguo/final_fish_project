              ...
              <el-row>
                <el-col :span="24">
                  <middleBottomLREcharts
                    v-bind:echartId="'middleBottomLEchartsId'"
                    :OptionData="middleBottomLOption"
                  ></middleBottomLREcharts>
                </el-col>
              </el-row>
            </li>
          ...
          <ul>
            ...
            <li>
              <el-row>
                <el-col :span="24">
                  <middleBottomLREcharts
                    v-bind:echartId="'middleBottomREchartsId'"
                    :OptionData="middleBottomROption"
                  ></middleBottomLREcharts>
                </el-col>
              </el-row>
            </li>
        ...
        <ul>
          ...
          <li>
            <el-row>
              <el-col :span="24">
                <rightBottomEcharts
                  v-bind:echartId="'rightTopEchartsId'"
                  :OptionData="rightTopOption"
                ></rightBottomEcharts>
              </el-col>
            </el-row>
          </li>
        ...
        <ul>
          ...
          <li>
            <el-row>
              <el-col :span="24">
                <rightBottomEcharts
                  v-bind:echartId="'rightMiddleEchartsId'"
                  :OptionData="rightMiddleOption"
                ></rightBottomEcharts>
              </el-col>
            </el-row>
          </li>
        ...
        <ul>
          ...
          <li>
            <el-row>
              <el-col :span="24">
                <rightBottomEcharts
                  v-bind:echartId="'rightBottomEchartsId'"
                  :OptionData="rightBottomOption"
                ></rightBottomEcharts>
              </el-col>
            </el-row>
          </li>
...
export default {
  ...
  methods: {
    ...
    drawLeftMiddleCharts() {
      ...
      baiduMap() {
         //创建实例
          var map = new BMap.Map("MiddleTopMainMap", {enableMapClick: false});
          //创建坐标点
          ...
          if (document.createElement('canvas').getContext) {  // 判断当前浏览器是否支持绘制海量点
              ...
              pointCollection.addEventListener('click', function (e) {
                  ...
                  for (var i = 0; i < _this.shipLocationArr.length; i++) {
                      if(_this.shipLocationArr[i].longitude==e.point.lng&&_this.shipLocationArr[i].latitude==e.point.lat){// 经度==点击的,维度
                          break;
                      }
                  }
