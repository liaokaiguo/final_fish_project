					...
					<div>
						<el-form ref="loginForm" :model="user" :rules="rules" status-icon  label-with="80px" >
							...
							<el-form-item prop="name" class="loginInput">
								<el-input v-model="user.name" placeholder="用户名" prefix-icon="el-icon-user" @keyup.enter.native="login()">
								</el-input>
							</el-form-item>

							<el-form-item prop="pass" class="loginInput">

								<el-input v-model="user.pass" type="password" placeholder="密码" prefix-icon="el-icon-lock" @keyup.enter.native="login()">
								</el-input>
							</el-form-item>
